...
export default class AddVehicle extends Component
{
    ...
    render() {
        return <section className="add-vehicle">
            ...
            <form action="">
                <div className="form-group-container">
                    ...
                    <input type="text" placeholder="Personbil" id="type" onChange={this.handleChange} value={this.state.type || ""} />
                </div>
                ...
                <div className="form-group-container">
                    ...
                    <input type="text" placeholder="Mazda" id="brand" onChange={this.handleChange} value={this.state.brand || ""} />
                </div>
                ...
                <div className="form-group-container">
                    ...
                    <input type="text" placeholder="1995" id="year" onChange={this.handleChange} value={this.state.year || ""} />
                </div>
                ...
                <div className="form-group-container">
                    ...
                    <input type="text" placeholder="999" id="price" onChange={this.handleChange} value={this.state.price || ""} />
                </div>

                <div className="form-group-container">
                    <label htmlFor="image">Bildlänk</label>
                    <input type="text" placeholder="http://example.com" id="image" onChange={this.handleChange} value={this.state.image || ""} />
                </div>
