      ...
      <nav className={"menu"}>
        <div className={"menu-container"}>
          <ul className={"menu-ul"}>
            <li className={"menu-li"}><a href="#show" onClick={this.props.checkUrl}>Visa alla fordon</a></li>
          ...
          <ul className={"menu-ul"}>
            ...
            <li className={"menu-li"}><a href="#remove" onClick={this.props.checkUrl}>Ta bort fordon</a></li>
